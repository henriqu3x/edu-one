  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-4 py-16 max-w-4xl">
        <h1 className="text-4xl font-bold mb-8 text-center">TERMO DE USO – EduOne</h1>
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <p className="mb-6">
            Bem-vindo(a) à EduOne (“Plataforma”). Estes Termos de Uso (“Termos”) regulam o acesso e a utilização do site www.EduOne.com e de todos os serviços oferecidos.
          </p>
          ...
          <p className="mb-6">
            O EduOne atua como provedor de aplicação, disponibilizando a infraestrutura tecnológica para o compartilhamento de conteúdo educativo, sem interferir na autoria, veracidade ou licitude do material publicado pelos Usuários.
          </p>
          ...
          <p className="mb-6">
            3.3. O Usuário declara ser o único responsável pelo conteúdo que publicar, isentando o EduOne de qualquer responsabilidade civil ou penal decorrente da publicação.
          </p>

          <h2 className="text-2xl font-semibold mt-8 mb-4">4. Licença de uso do conteúdo enviado</h2>
          <p className="mb-4">4.1. Ao enviar um vídeo, o Usuário concede ao EduOne uma licença gratuita, não exclusiva, mundial e por prazo indeterminado para:</p>
          <ul className="list-disc pl-6 mb-6 space-y-2">
          ...
          <ul className="list-disc pl-6 mb-6 space-y-2">
            ...
            <li>O EduOne não hospeda, copia ou modifica vídeos de terceiros.</li>
          </ul>

          <h2 className="text-2xl font-semibold mt-8 mb-4">6. Moderação e remoção de conteúdo</h2>
          <ul className="list-disc pl-6 mb-6 space-y-2">
            <li>O EduOne reserva-se o direito de revisar, moderar, ocultar ou remover vídeos ou perfis que violem estes Termos ou a legislação vigente, sem necessidade de aviso prévio.</li>
            <li>Caso o Usuário acredite que algum conteúdo viole direitos autorais ou legais, poderá solicitar a remoção através do e-mail: contato@EduOne.com.</li>
          ...
          <ul className="list-disc pl-6 mb-6 space-y-2">
            ...
            <li>O EduOne não se responsabiliza por:</li>
            <ul className="list-disc pl-6 mb-6 space-y-2">
          ...
          <ul className="list-disc pl-6 mb-6 space-y-2">
            <li>O layout, logotipos, textos, design e funcionalidades da Plataforma são de propriedade exclusiva do EduOne e protegidos por direitos autorais.</li>
          ...
          <p className="mb-6">
            O EduOne poderá modificar estes Termos a qualquer momento.
          ...
          <div className="mt-12 p-6 bg-muted rounded-lg">
            ...
            <p className="mb-2"><strong>E-mail:</strong> contato@EduOne.com</p>
            <p><strong>Site:</strong> www.EduOne.com</p>
          </div>
        </div>
      </div>
    </div>
